...
def _update_flags(flags, test_name):
  ...
  flags.num_train_steps = 100000000
  flags.steps_per_stats = 100
  flags.src = "en"
  flags.tgt = "vi"

  flags.train_prefix = ("d:/project/nmt-master/nmt/testdata/"
                        "iwslt15.tst2013.100")
  flags.vocab_prefix = ("d:/project/nmt-master/nmt/testdata/"
                        "iwslt15.vocab.100")
  flags.dev_prefix = ("d:/project/nmt-master/nmt/testdata/"
                      "iwslt15.tst2013.100")
  flags.test_prefix = ("d:/project/nmt-master/nmt/testdata/"
                       "iwslt15.tst2013.100")
...
class NMTTest(tf.test.TestCase):
  ...
  def testInference(self):
    ...
    FLAGS.inference_input_file = ("d:/project/nmt-master/nmt/testdata/"
                                  "iwslt15.tst2013.100.en")
    FLAGS.inference_output_file = os.path.join(FLAGS.out_dir, "output")
    FLAGS.inference_ref_file = ("d:/project/nmt-master/nmt/testdata/"
